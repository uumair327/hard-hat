...
class DependencyInjectionExample {
  ...
  static Future<void> exampleSystemRegistration() async {
    ...
    print('Movement system retrieved: true');
    print('Entity manager available: true');
  ...
  static Future<void> exampleEntityFactories() async {
    ...
    GameServiceLocator.getFactory<PlayerEntityFactory>();
    GameServiceLocator.getFactory<BallEntityFactory>();
    GameServiceLocator.getFactory<TileEntityFactory>();

    print('Player factory available: true');
    print('Ball factory available: true');
    print('Tile factory available: true');
  ...
  static Future<void> exampleSystemLifecycle() async {
    ...
    print(
      'System registered: ${GameServiceLocator.hasGameSystem<MovementSystem>()}',
    );
    ...
    print(
      'System after unregister: ${GameServiceLocator.hasGameSystem<MovementSystem>()}',
    );
