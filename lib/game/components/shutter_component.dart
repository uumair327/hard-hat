...
class ShutterComponent extends PositionComponent with CollisionCallbacks {
  ...
  bool get isSliding =>
      _activated && _slideProgress > 0.0 && _slideProgress < 1.0;
  ...
  Future<void> onLoad() async {
    ...
    add(RectangleHitbox());
    try {
      _sprite = await Flame.images.load('sprites/tiles/shutter.png');
    } catch (_) {}
  }
...
class RetractingShutterComponent extends PositionComponent
  ...
  bool get isSliding => _opening || _retracting;
