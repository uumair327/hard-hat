...
void main() {
  group('ParticleSystem Tests', () {
    ...
    test(
      'should spawn destruction particles for different tile types',
      () async {
        // Arrange
        await particleSystem.initialize();
        ...
        // Act
        particleSystem.spawnDestructionParticles(
          position,
  ...
  group('ParticlePool Tests', () {
    ...
    test('should update active particles and return inactive ones', () {
      ...
      expect(
        stats['active'],
        lessThanOrEqualTo(1),
      ); // May still be active due to timing
  ...
  group('ParticleComponent Tests', () {
    ...
    test('should deactivate particle when lifetime expires', () {
      // Arrange
      final particle = Particle(position: Vector2(0, 0), lifetime: 0.5);
  ...
  group('Property-Based Tests', () {
    ...
    test(
      'Property 33: Impact particle spawning - For any Physics_Ball surface impact, star particles should be spawned at the collision point',
      () {
        ...
        for (int i = 0; i < 100; i++) {
          ...
          expect(
            ...
            greaterThan(0),
            reason:
                'Impact particles should spawn emitters at position $position',
          );
          expect(
            stats['totalActiveParticles'],
            greaterThan(0),
            reason:
                'Impact particles should create active particles at position $position',
          );
        }
      },
    );
    ...
    test(
      'Property 34: Material-specific particles - For any tile destruction, the Particle_System should create particles appropriate to the tile material',
      () {
        ...
        for (int i = 0; i < 100; i++) {
          ...
          expect(
            ...
            greaterThan(0),
            reason:
                'Destruction particles should spawn emitters for $tileType at position $position',
          );
          expect(
            stats['totalActiveParticles'],
            greaterThan(0),
            reason:
                'Destruction particles should create active particles for $tileType at position $position',
          );
    ...
    test(
      'Property 35: Movement particle generation - For any Player_Character movement, appropriate step particles should be generated',
      () {
        ...
        for (int i = 0; i < 100; i++) {
          ...
          expect(
            ...
            greaterThan(0),
            reason:
                'Movement particles should spawn emitters at position $position',
          );
          expect(
            stats['totalActiveParticles'],
            greaterThan(0),
            reason:
                'Movement particles should create active particles at position $position',
          );
          ...
          expect(
            ...
            lessThanOrEqualTo(5),
            reason:
                'Movement particles should be subtle (few particles) at position $position',
          );
        }
      },
    );
